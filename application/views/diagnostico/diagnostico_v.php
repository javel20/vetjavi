	...
	<div class="col-sm-9 col-md-10 affix-content">
		<div class="container">
            <div class="page-header">
                ...
                <br>  
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" position='left'>
                        ...
                        <a class="otromas" href="/vetjavi/index.php/diagnostico/create">
                            <button type="button" class="btn btn-primary">Agregar diagnostico</button>
                        </a>
                    </div>
                </form>
            ...
            <nav class="navbar navbar-default navbar-text navbar-right" >
                ...
                <form class="navbar-form navbar-left"
                        action="<?php echo base_url('index.php/diagnostico/search'); ?>"
                        method="GET">
                ...
                "<td> <div class='dropdown'>
                    ...
                    <ul class='dropdown-menu' aria-labelledby='dLabel'>
                        ...
                        <li><a  dato_modal='dato_eliminar'
                                ...
                                nombre_data='". $dato->CodigoD ."'
                                url_data=". base_url("index.php/Diagnostico/delete/$dato->IdDiagnostico") .">Eliminar</a></li>
                        <li><a href=". base_url("index.php/Diagnostico/edit/$dato->IdDiagnostico") .">Editar</a></li>
