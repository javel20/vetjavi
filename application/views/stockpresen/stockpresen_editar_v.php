	...
	<div class="col-sm-9 col-md-10 affix-content">
      ...
      <div class="page-header">
        ...
        <form class="row mrb-30 well" 
          ...
          <div class="form-group col-md-6">
            <label>Precio</label>
            <input validate="decimal" type="text" class="form-control" name="Precio"  maxlength="7"value="<?php echo $dato_stockpresen[0]->Precio?>">
          </div>

          <div class="form-group col-md-6">
            <label>Precio Venta</label>
            <input validate="decimal" type="text" class="form-control" name="PrecioVenta"  maxlength="7"value="<?php echo $dato_stockpresen[0]->PrecioVenta?>">
          </div>
