		...
		<div class="container">
            ...
            <nav class="navbar navbar-default navbar-text navbar-right" >
                ...
                <form class="navbar-form navbar-left" 
                        action="<?php echo base_url('index.php/cirugia/search'); ?>"  
                        method="GET">
                ...
                "<td> <div class='dropdown'>
                    ...
                    <ul class='dropdown-menu' aria-labelledby='dLabel'>
                        ...
                        <li><a  dato_modal='dato_eliminar'
                                ...
                                nombre_data='". $dato->NombreC ."'
                                url_data=". base_url("index.php/cirugia/delete/$dato->IdCirugia") .">Eliminar</a></li>
                        <li><a href=". base_url("index.php/cirugia/edit/$dato->IdCirugia") .">Editar</a></li>
