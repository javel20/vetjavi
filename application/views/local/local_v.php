            ...
            <div class="page-header">
                ...
                <nav class="navbar navbar-default navbar-text navbar-right" >
                    ...
                    <form class="navbar-form navbar-left"
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-btn">
                                ...
                                <ul class="dropdown-menu" id="menu_a_buscar">
                                    <li><a href="#" dato="NombreL">Nombre </a></li>
                                        <li><a href="#" dato="EstadoL">Estado </a></li>
                        ...
                        <input type="hidden" id="tipo_dato" name="tipo_dato" value="<?php echo $this->input->get('nombre_dato') ? $this->input->get('tipo_dato') : 'NombreL';?>">
                        <input type="hidden" id="nombre_dato" name="nombre_dato" value="<?php echo $this->input->get('nombre_dato') ? $this->input->get('nombre_dato') : 'NombreL';?>">
                ...
                <table class="table">
                    ...
                    <?php
                        ...
                        foreach ($datos_local as &$dato) {
                            echo "<tr>".
                            "<td>". $dato->NombreL ."</td>".
                            "<td>". $dato->DireccionL ."</td>".
                            "<td>". $dato->TelefonoL ."</td>".
                            "<td>". $dato->EstadoL ."</td>".
