...
class Paciente extends CI_Controller {
    ...
    use Permisos_trait;
        ...
        public function search(){
          ...
          $this->load->library('pagination');
          $this->load->model('Paciente_model');
          $data['datos_paciente'] =  $this->Paciente_model->get_buscar_paciente($inicio,$limite);
          $config['base_url'] = base_url().'index.php/paciente/search?nombre_buscar='.$_GET['nombre_buscar'].'&tipo_dato='.$_GET['tipo_dato'].'&nombre_dato='.$_GET['nombre_dato'];
          $config['total_rows'] = count($this->Paciente_model->get_buscar_paciente());
          $config['per_page'] = 10;

          $config['first_url'] = base_url().'index.php/paciente/search?nombre_buscar='.$_GET['nombre_buscar'].'&tipo_dato='.$_GET['tipo_dato'].'&nombre_dato='.$_GET['nombre_dato']."&per_page=1";
