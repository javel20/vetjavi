...
class Cliente extends CI_Controller {
    ...
    use Permisos_trait;
        ...
        public function search(){
          ...
          $data['datos_cliente'] =  $this->Cliente_model->get_buscar_cliente($inicio,$limite);
          $config['base_url'] = base_url().'index.php/cliente/search?nombre_buscar='.$_GET['nombre_buscar'].'&tipo_dato='.$_GET['tipo_dato'].'&nombre_dato='.$_GET['nombre_dato'];
          $config['total_rows'] = count($this->Cliente_model->get_buscar_cliente());
          $config['per_page'] = 10;

          $config['first_url'] = base_url().'index.php/cliente/search?nombre_buscar='.$_GET['nombre_buscar'].'&tipo_dato='.$_GET['tipo_dato'].'&nombre_dato='.$_GET['nombre_dato']."&per_page=1";
